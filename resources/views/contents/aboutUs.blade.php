                        ...
                        <blockquote class="blockquote mb-2">
                            <div class="row">
                                <div class="col-md-6 abt">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#008F69"
                                    ...
                                    <p> Techno Celebes adalah sebuah perusahaan yang bergerak di bidang teknologi informasi
                                    </p>
                                </div>
                                <div class="col-md-6 abt">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#8A02A5"
                                    ...
                                    <p> Berdiri sejak tahun 2013 dan resmi menjadi CV pada bulan Mei, tahun 2020
                                    </p>
                                </div>
                            </div>
                            <div class="row">
